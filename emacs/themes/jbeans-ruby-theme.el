;;; jbeans-ruby-theme.el --- Jbeans theme for GNU Emacs 24 (deftheme) modified

;; Author: Pablo Palomino <hi@iampablopg.com>

(deftheme jbeans-ruby)
(let ((class '((class color) (min-colors 89)))
      ;;                                            GUI       TER
      (jbeans-fg         (if (display-graphic-p) "#d4d4d4" "#cccccc"))
      (jbeans-bg         (if (display-graphic-p) "#1e1e1e" "#151515"))
...
;;;;; Helm
       ...
       `(helm-source-header                  ((,class (:foreground ,jbeans-yellow-3 :background ,jbeans-bg))))
       `(helm-swoop-target-line-face         ((,class (:foreground ,jbeans-fg :background ,jbeans-bg))))
...
;; End:
;;; jbeans-ruby-theme.el ends here
